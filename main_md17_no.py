...
import random
import numpy as np
from training_utils import ensure_exp_dir, init_history, save_checkpoint, save_config, save_history, save_summary
...
def main():
    ...
    for epoch in range(args.epochs):
        ...
        if epoch % args.test_interval == 0:
            ...
            results['eval'].append({'epoch': epoch, 'val_loss': val_loss, 'test_loss': test_loss})
